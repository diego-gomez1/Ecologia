...
const coloresMarcadores = {
    ...
    'casi-amenazada': '#2A9D8F', // Verde turquesa
...
function aplicarFiltros() {
    ...
    // Obtener filtros de peligro marcados
    ...
    marcadores.forEach(marker => {
        ...
        // Verificar peligro con lógica de 3 colores consolidada
        let cumplePeligro = false;
        
        if (categoriasSeleccionadas.length > 0) {
            // Verificar cada categoría seleccionada
            if (categoriasSeleccionadas.includes('critico')) {
                // Rojo incluye: critico Y peligro
                if (especie.nivelPeligro === 'critico' || especie.nivelPeligro === 'peligro') {
                    cumplePeligro = true;
                }
            }
            if (categoriasSeleccionadas.includes('vulnerable')) {
                // Amarillo incluye: vulnerable
                if (especie.nivelPeligro === 'vulnerable') {
                    cumplePeligro = true;
                }
            }
            if (categoriasSeleccionadas.includes('menor')) {
                // Verde incluye: menor
